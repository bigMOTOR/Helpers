...
public extension Publisher {
  func shareReplay(_ bufferSize: Int) -> Publishers.Autoconnect<Publishers.Multicast<Self, ReplaySubject<Output, Failure>>> {
    return self.multicast(subject: ReplaySubject(bufferSize))
      .autoconnect()
  }
}
